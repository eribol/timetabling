...
impl Color {
    ...
    pub fn into_vec(self) -> Vec<f32> {
        match self {
            Color::Rgb(rgb) => {
                vec![rgb.r as f32, rgb.g as f32, rgb.b as f32]
            }
            Color::Cmyk(cmyk) => {
                vec![cmyk.c as f32, cmyk.m as f32, cmyk.y as f32, cmyk.k as f32]
            }
            Color::Greyscale(gs) => {
                vec![gs.percent as f32]
            }
            Color::SpotColor(spot) => {
                vec![spot.c as f32, spot.m as f32, spot.y as f32, spot.k as f32]
            }
        }
    }
